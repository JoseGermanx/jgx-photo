    ...
    <div className="container px-5 py-10 mx-auto text-center lg:px-40">
      <div className="flex flex-col w-full mb-20">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
          Nuestros servicios son personalizados y nos aseguramos de que cada cliente reciba la atención que merece.
        </p>
      </div>
          ...
          <a
            ...
            <div className="flex relative">
              ...
              <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-black opacity-0 hover:opacity-100">
                <h2 className="tracking-widest text-sm title-font font-medium text-white-400 mb-1">
                  {project.subtitle}
                </h2>
